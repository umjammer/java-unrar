...
JUnRar ( java-unrar ) is a rar handling api implemented in pure java.<br/>
Files can be read form memory/file and be written to memory/file/any other outputstream.<br/>
the api is based on unrar-3.7.6
